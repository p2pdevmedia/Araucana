...
export default async function HomePage() {
  ...
  return <>
    ...
    <main>
      ...
      <section className="door-section compact-door-section page-shell"><div className="door-copy"><p className="eyebrow eyebrow-light">Servicio gratuito</p><h2>Servicio<br /><em>puerta a puerta.</em></h2><p>Nosotros nos ocupamos del traslado.<br /><strong>Vos disfrutás el viaje.</strong></p><p className="door-extra">También podés guardar tu equipo o valija en nuestra oficina del centro durante el día.</p><Link className="light-link" href="#contacto">Conocé más <span>↗</span></Link></div><div className="door-stamp"><span>Desde tu origen</span><b>→</b><span>Hasta tu destino</span></div></section>
